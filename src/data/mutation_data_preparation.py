...
def _write_csv_files(slide_folders: str, output_folder: str, patient_to_category: Dict[str, str], mutations_per_patient: Dict[str, list], slides_meta: Dict[str, str], luad_tiles: List[str] = None) -> None:
    path_train = os.path.join(output_folder, 'csv_train_mutations_split3.csv')
    path_test = os.path.join(output_folder, 'csv_test_mutations_split3.csv')
    path_valid = os.path.join(output_folder, 'csv_valid_mutations_split3.csv')
