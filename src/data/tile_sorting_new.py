...
def _write_info(slide_folder: str, output_csv: dict, output_folder: str, patient_meta: pd.DataFrame, patient_to_category: Dict[str, str], classes: Dict[str, int]) -> None:
